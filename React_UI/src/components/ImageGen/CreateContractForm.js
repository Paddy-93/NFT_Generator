...
const CreateContractForm = ({layerOrder, directory, contractMeta}) => {
    ...
    const initialConstructors = [
      ...
      {name: "metadata", value: contractMeta, label: "Metadata "},
    ...
    const handleCreateClick = async() => {
      ...
      debugger;
      // const [contractName, symbol, metadata, price, totalSupply, maxMintAmount] = nftConstructors;
      // /*Generate all Images*/
      ...
      // let contract = await factory.deploy(contractName.value,symbol.value,utils.parseEther(price.value),totalSupply.value,maxMintAmount.value, null, metadata.value, true);
